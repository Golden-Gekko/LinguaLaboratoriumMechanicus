...
# CPT
uv run python utils/extract_text_to_json.py --input books/ --output dataset/json_data
uv run python tokenizer/train_tokenizer.py --data_dir dataset/json_data --save_dir tokenizer/tokenizer_config
uv run python train.py --batch_size 4 --max_epochs 10
